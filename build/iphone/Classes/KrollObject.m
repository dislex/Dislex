 ...
 * Copyright (c) 2009-2011 by Dislex, Inc. All Rights Reserved.
...
//@interface DislexObject : NSObject
//@end

@interface DislexObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[DislexObject class]])
		{
			for (NSString *key in [[(DislexObject*)o modules] allKeys])
			{
