...
// in simulator we redefine to format for Dislex Developer console
...
{\
	NSString * exceptionName = [@"org.dislex." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dislex";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIDislexNativeItemNone = -1, 
	UIDislexNativeItemSpinner = -2,
	UIDislexNativeItemProgressBar = -3,
	
	UIDislexNativeItemSlider = -4,
	UIDislexNativeItemSwitch = -5,
	UIDislexNativeItemMultiButton = -6,
	UIDislexNativeItemSegmented = -7,
	
	UIDislexNativeItemTextView = -8,
	UIDislexNativeItemTextField = -9,
	UIDislexNativeItemSearchBar = -10,
	
	UIDislexNativeItemPicker = -11,
	UIDislexNativeItemDatePicker = -12,
	
	UIDislexNativeItemInfoLight = -13,
	UIDislexNativeItemInfoDark = -14,
	
	UIDislexNativeItemDisclosure = -15,
	
	UIDislexNativeItemContactAdd = -16
};
